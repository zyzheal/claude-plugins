...
description: >-
  Guides completion of development work - merge, PR creation, or cleanup after tests pass.
  Trigger: finish branch, merge, PR, complete, 完成分支, 合并.
  Use when: implementation is complete and user asks to finish, merge, or create PR.
---
