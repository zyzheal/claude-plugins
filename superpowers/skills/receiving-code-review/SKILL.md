...
description: >-
  Use when receiving code review feedback, before implementing suggestions, especially if feedback seems unclear or technically questionable - requires technical rigor and verification, not performative agreement or blind implementation Trigger: code review feedback implement review 代码审查. When asked to code review feedback implement review 代码审查.
---
...
2. **执行核心操作** — 按照 receiving-code-review 的具体能力执行任务
