...
description: >-
  Use when implementing any feature or bugfix, before writing implementation code Trigger: TDD test-driven test driven 测试驱动. When asked to TDD test-driven test driven 测试驱动.
---
...
2. **执行核心操作** — 按照 test-driven-development 的具体能力执行任务
