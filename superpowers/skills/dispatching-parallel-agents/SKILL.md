...
description: >-
  Use when facing 2+ independent tasks that can be worked on without shared state or sequential dependencies Trigger: parallel agent dispatch 并行 agent. When asked to parallel agent dispatch 并行 agent.
---
...
2. **执行核心操作** — 按照 dispatching-parallel-agents 的具体能力执行任务
