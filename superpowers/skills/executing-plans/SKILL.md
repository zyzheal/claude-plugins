...
description: >-
  Execute written implementation plans with review checkpoints between task phases.
  Trigger: execute plan, implementation, 执行计划, 实现.
  Use when: user asks to execute an implementation plan or run tasks from a plan.
---
