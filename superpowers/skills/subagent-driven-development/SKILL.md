...
description: >-
  Use when executing implementation plans with independent tasks in the current session Trigger: subagent agent development sub agent 子代理. When asked to subagent agent development sub agent 子代理.
---
...
2. **执行核心操作** — 按照 subagent-driven-development 的具体能力执行任务
